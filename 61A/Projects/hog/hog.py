...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while i < num_rolls:
        ...
        if roll == 1:
            ...
            roll_sum += roll
        i += 1
    return (pigout and 1) or roll_sum
    # END PROBLEM 1
...
def free_bacon(score):
    ...
    if len(score_string) < 2:
        abs_sum = 2 + abs(0 - score)
    else:
        abs_sum = 2 + abs(int(score_string[0]) - int(score_string[1]))
    return abs_sum
    # END PROBLEM 2
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        num_rolls = strategy0(score0, score1) if player == 0 else strategy1(score1, score0)
        if player == 0:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=10):
