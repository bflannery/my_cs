...
def replace_leaf(t, old, new):
    ...
    if is_leaf(t):
        ...
        sticks = [replace_leaf(b, old, new) for b in branches(t)]
        return tree(label(t), sticks)
...
class Account:
    ...
    def time_to_retire(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        years_to_retire, balance_with_interest = 0, self.balance
        while balance_with_interest < amount:
            balance_with_interest += (balance_with_interest * Account.interest)
            years_to_retire += 1
