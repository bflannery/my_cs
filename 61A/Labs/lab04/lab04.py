...
def distance(city1, city2):
    ...
    return sqrt((city_1_lat - city_2_lat)**2 + (city_1_lon - city_2_lon)**2)
...
def closer_city(lat, lon, city1, city2):
    ...
    temp_city = make_city('Test_Location', lat, lon)
    city_1_distance = distance(temp_city, city1)
    city_2_distnce = distance(temp_city, city2)

    return get_name(city1) if city_1_distance < city_2_distnce else get_name(city2)
